...
static char *month_names[12] = { "Jan", "Feb", "Mar", "Apr", "Mai", "Jun",
                                 "Jul", "Aug", "Sep", "Okt", "Nov", "Des"
                               };

static char *weekday_name[] = { "Monday", "Tuesday", "Wednesday",
                                "Thursday", "Friday", "Saturday", "Sunday"
                              };
static char *weekday_navn[] = { "Mandag", "Tirsdag", "Onsdag",
                                "Torsdag", "Fredag", "Lørdag", "Søndag"
                              };
static char *weekday_name_short[] = { "Mon", "Tue", "Wed",
                                      "Thu", "Fri", "Sat", "Sun"
                                    };
static char *weekday_navn_kort[] = { "Man", "Tir", "Ons",
                                     "Tor", "Fre", "Lør", "Søn"
                                   };
...
char *Date::Get_weekday_name_eng(void)
{
    return weekday_name[Get_weekday_index()];
}


char *Date::Get_weekday_name_norw(void)
{
    return weekday_navn[Get_weekday_index()];
}


char *Date::Get_weekday_name_eng_short(void)
{
    return weekday_name_short[Get_weekday_index()];
}


char *Date::Get_weekday_name_norw_short(void)
{
...
char *Date::getMonthString() const
{
    if (*this == NoDate)
    {
        return "null";
